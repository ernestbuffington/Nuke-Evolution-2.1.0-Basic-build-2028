...
$lang_admin[$settingspoint]['FIELD_FTPPWD_HELP'] = 'The Passwort for the User to have FTP Access.<br />You should insert here the same password you used for your FTP program.';
