...
function ya_passCheck($user_pass1, $user_pass2) {
    ...
    if (strlen($user_pass1) > $evoconfig['pass_max']) $stop = "<center>"._YA_PASSLENGTH."</center><br />";
    if (strlen($user_pass1) < $evoconfig['pass_min']) $stop = "<center>"._YA_PASSLENGTH."</center><br />";
