...
define("_SN_ERROR_SAVE","ERROR: Your Story couldn`t be saved into the database. Please contact website administrator");
define("_SN_ERROR_STORY","You didn`t fill stories text");
define("_SN_ERROR_SUBJECT","You must specify a subject");
